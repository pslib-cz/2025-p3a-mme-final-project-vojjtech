...
Vyměnitelný přední panel: Přední část šuplíku (plate) je oddělitelná. Můžeš si snadno vytisknout jiný design, přidat nápis nebo logo bez nutnosti tisknout znovu celý šuplík.
...
Šuplík (Drawer): Vnitřní výsuvná část.

Čelní panel (Front Plate): Vyměnitelný prvek pro vlastní design.
